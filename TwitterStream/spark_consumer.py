...
def main():
    # load
    nfeeling_words = load_word_list("/home/liufudijacky/spark/Dataset/nFeeling.txt")
    pfeeling_words = load_word_list("/home/liufudijacky/spark/Dataset/pFeeling.txt")
    ...
    tweets = kstream.map(lambda x: x[1].encode("ascii", "ingnore"))
